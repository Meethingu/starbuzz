...
class ListingEmployees extends StatefulWidget {
  @override
  _ListingEmployeesState createState() => _ListingEmployeesState();
}

class _ListingEmployeesState extends State<ListingEmployees> {
  List users = [];
